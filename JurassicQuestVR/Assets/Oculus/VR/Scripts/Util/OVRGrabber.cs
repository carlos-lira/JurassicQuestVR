...
public class OVRGrabber : MonoBehaviour
{
    ...
    void OnUpdatedAnchors()
    {
        ...
        bool pressed = OVRInput.GetDown(OVRInput.Button.PrimaryHandTrigger, m_controller);
        bool released = OVRInput.GetUp(OVRInput.Button.One, m_controller);
        ...
        //CheckForGrabOrReleaseNew(pressed);
